          ...
          <section class="wrapper">
              ...
              <div class="row">
                  ...
                  <div class="form-panel">
                      <h4 class="mb"><i class="fa fa-angle-right"></i> Upload a New Product</h4>
                      <form class="form-horizontal style-form" method="get">
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Offer Highlight:</label>
                              <div class="col-sm-10">
                                  <input type="text" id="focusedInput" class="form-control round-form">
                              </div>
                          </div>
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Banner Main Text:</label>
                              <div class="col-sm-10">
