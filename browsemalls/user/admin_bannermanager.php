        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li class="active">
                        <a href="bannermanager.php"><i class="fa fa-fw fa-dashboard"></i> Advertisement Banner</a>
                    </li>
                    <li>
                        <a href="#"><i class="fa fa-fw fa-bar-chart-o"></i> Featured Adds</a>
                    </li>
                    <li>
                        <a href="admin_shopownerprofiles.php"><i class="fa fa-fw fa-table"></i> Shop Owner Profiles</a>
                    </li>
                    <li>
                                ...
                                <tbody>
                                    <?php
                                        ...
                                        while($row = mysqli_fetch_assoc($query1)){
                                            $il = $row['imagelocation'];
                                            $clicks = 0;
                                            $shop_name = $row['shopid']; 
                                            $ht = $row['htext'];
                                            echo "<tr>
                                                    <td><img class=\"thumbnail\"src=\"/browsemalls/$il\" height=\"200px\" width=\"200px\"></td>
                                                    <td>$clicks</td>
                                                    <td>$shop_name</td>
                                                    <td>$ht</td>
                                                  </tr>";
