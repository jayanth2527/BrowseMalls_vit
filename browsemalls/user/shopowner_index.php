...
<head>
    ...
    <title><?php echo $_SESSION['so']; ?></title>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <ul class="nav navbar-right top-nav">
                ...
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-user"></i>&nbsp;&nbsp;<?php echo $_SESSION['so']?> <b class="caret"></b></a>
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    <li class="active">
                        <a href="#"><i class="fa fa-fw fa-dashboard"></i> Shop Owner Profile</a>
                    </l>
                    <li>
                        <a href="#"><i class="fa fa-fw fa-table"></i> Product Management</a>
                    </li>
                    <li >
                        <a href="#"><i class="fa fa-fw fa-dashboard"></i> Homepage Banner</a>
                    </li>
                    <li>
                        <a href="#"><i class="fa fa-fw fa-bar-chart-o"></i> Accounting</a>
                    </li>
