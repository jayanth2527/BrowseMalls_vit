...
if(isset($_POST['abutton']))
{
	...
	if(!empty($_POST['aid']) && !empty($_POST['password']))
	{
		...
		$query=mysqli_query($connect,"SELECT * FROM `$tbl_name` WHERE admin_password='$password' AND admin_user_name='$aid'");
		...
		{		
			...
			<strong>Wrong!</strong> Credentials incorrect.
			</div>";
		}
	}
	else
				...
				<div class="col-sm-4 col-sm-offset-1">
					<div class="login-form"><!--login form-->
						...
						<form action="login.php" method="post">
							<input type="text" name="aid" placeholder="User Name or Mobile Number" />
